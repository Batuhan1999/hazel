                ...
                {((msg.user && showUserLabel) || msg.sentAt || msg.status) && (
                    <div className="flex items-center gap-2">
                        ...
                        {msg.user && showUserLabel && (
                            <span className="flex-1 truncate text-sm font-medium text-secondary">{msg.user.me ? "You" : msg.user.name}</span>
                        )}
                ...
                {msg.text ? (
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex items-center gap-1">
                            <p className="min-w-0 flex-1 truncate text-sm font-medium text-secondary">{msg.image.name}</p>
